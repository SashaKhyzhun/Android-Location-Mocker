package com.sashakhyzhun.locationmocker.ui.mylist;
...
import com.sashakhyzhun.locationmocker.adapters.EmptyListAdapter;
...
public class MyListViewActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ab.setTitle(from_id); //CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL, from_id));
    ...
    public void refreshList(final String from_id){
        ...
        if(listOfLocations.size() == 0){
            ...
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                String from = from_id; //CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL, from_id);
...
//            super.onBackPressed();
            ...
            ab.setTitle(MyStrings.favID); //CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL, MyStrings.favID));

        } else if(id == R.id.nav_recent){
            refreshList(MyStrings.recID);
            ab.setTitle(MyStrings.recID); //CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL, MyStrings.recID));
