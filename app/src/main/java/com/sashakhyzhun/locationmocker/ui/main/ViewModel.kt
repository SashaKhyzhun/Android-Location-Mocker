...
class ViewModel constructor(app: Application) : AndroidViewModel(app) {
    ...
    var mockNetwork: MockLocationProvider? = null
...
//    }
    ...
    fun applyLocation(ctx: Context, mockLocation: MockLocation) {
        ...
        try {
            mockNetwork = MockLocationProvider(LocationManager.NETWORK_PROVIDER, ctx)
            mockGps = MockLocationProvider(LocationManager.GPS_PROVIDER, ctx)
